...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCompletedToDos = (LinearLayout) findViewById(R.id.ll_completed_to_do_items);
        mCompletedToDos.setOnClickListener(new View.OnClickListener() {
            @Override
